...
class usuario
{
   ...
   public function subcription(){
    $conexion = bd::connection();
    $coleccion = $conexion->subcription;
    try {
    $resultados = $coleccion->insertOne([
        "correo" => $this->correo,
        "fecha_registro" => date("Y-m-d"),
    ...
    public function validateUser()
    {
        ...
        $conexion = bd::connection();
        $coleccion = $conexion->usuario->find(["usuario" => $this->usuario]);
    ...
    public function validateEmail(){
        ...
        $conexion = bd::connection();
        $coleccion = $conexion->usuario->find(["correo" => $this->correo]);
    ...
    public function getPaymetMet(){
        $conexion = bd::connection();
        $coleccion = $conexion->pagos_paypal->find(["user_id" => $this->id]);
