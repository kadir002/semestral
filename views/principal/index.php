...
<?php } else { ?>
			...
			<div class="container">
				<div class="row justify-content-center">
					<div class="col-sm-10 wrap-about ftco-animate text-center">
						...
						<form target="paypal" name="formpaymet" action="<?php echo "index.php?c=" . seg::codificar("pagos_paypal") . "&m=" . seg::codificar("registar_notificacion") ?>" method="post">
							...
							<!-- <input type="button" name="submit" value="Pagar con Paypal 49.99 "  class="btn btn-warning text-light"> -->
	...
	<section id="hero" class="d-flex flex-column justify-content-center align-items-center">
		<div class="hero-container" data-aos="fade-in">
			<h1>bienvenido <?php echo $_SESSION["nombre_contacto"];?></h1>
			<!-- <p>I'm <span class="typed" data-typed-items="Designer, Developer, Freelancer, Photographer"></span></p> -->
		</div>
	</section>
		</main>
